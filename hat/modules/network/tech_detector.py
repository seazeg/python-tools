...
# 导入特征签名
from .signatures import TECH_SIGNATURES  # 可以直接从 __init__.py 导入合并后的签名
from .signatures.web_servers import WEB_SERVERS
from .signatures.web_frameworks import WEB_FRAMEWORKS
from .signatures.js_frameworks import JS_FRAMEWORKS
from .signatures.build_tools import BUILD_TOOLS
from .signatures.js_libraries import JS_LIBRARIES
from .signatures.video_players import VIDEO_PLAYERS
from .signatures.chart_tools import CHART_TOOLS
from .signatures.cdn_providers import CDN_PROVIDERS
from .signatures.analytics import ANALYTICS
from .signatures.ui_frameworks import UI_FRAMEWORKS
from .signatures.state_management import STATE_MANAGEMENT
